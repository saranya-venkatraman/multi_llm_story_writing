...
def main():
    ...
    def get_story_from_hf_llm(data_df, ixs, num_attempts):  
        ...
        for index, row in df.iterrows():
            ...
            summary = summarizer(story_so_far, max_length=100, min_length=30, do_sample=False)
            ...
            prompt = 'Write 180 words \
                 to continue this storyline: {}. Continue from this sentence: {}'.format(summarized_story, last_story_sentence)
    ...
    combined_file = "/combined_files/{}_part{}.csv".format(total_authors, total_authors, author_num-1)
